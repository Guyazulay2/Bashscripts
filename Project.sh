...
(10) | Exit
Your choice :" ; read choose

if [ $choose == "1" ]; then
	echo "< Create ssh-keygen >" ; ssh-keygen
	sleep 0.5
	echo "Enter the client ip >:" ; read IP
	ssh-copy-id guy@$IP

elif [ $choose == "2" ]; then

	echo "Execute sudo without Password.."
	sleep 0.5 ; echo "Enter your username >:" && read USER
	echo '"$USER" ALL=(ALL) NOPASSWD: ALL' >> /etc/sudoers ; echo "Done"
	...
	echo "Enter the folder name >:" ;read FOLDER ; mkdir $FOLDER ; cd $FOLDER

	echo "Create Details file >:" ; touch details.txt
	
	echo "Enter your details :" ; echo "Full Name :" ; read NAME ; echo "Age :" ; read AGE
	echo "Phone Number :" ; read PHONE
	echo "Address :" ; read ADD
	...
	echo "Enter the IP >:" ; read IP ; scp details.txt guy@$IP:/home/guy/Desktop/details.txt
